...
<div class="container push-top">
	...
	<p>This privacy policy is for this website (https://beacon.pm) and governs the privacy of its users who choose to use it.</p>
	...
	<p>Although this website only looks to include quality, safe and relevant external links, users are advised adopt a policy of caution before clicking any external web links throughout this website that have been posted by other users. (External links are clickable text / banner / image links to other websites.</p>
	...
	<p>This website and its users through their social media platform accounts may share web links to external web pages. Some users may post shortened versions of lengthy urls [web addresses] (for example example: http://bit.ly/zyVUBo). 
